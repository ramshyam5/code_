...
float   fovl;  // globally declared object to be thrown when exception occurs
int     iovl;  // globally declared object to be thrown when exception occurs
...
{ 
     ...
     stack<int,1> s1;  //  one instance of the template class and one instance of the class is create
     stack<float,5> sf;   //  ???
