...
int main()
{
  ...
  auto duration = duration_cast<microseconds>(stop - start);  // Get duration and proper typecasted
  cout << "Time taken by program: "<< duration.count()/1000000 << " microseconds" << endl; 
